  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
    <div className="bg-[#111] border border-white/10 rounded p-8 max-w-sm w-full mx-4">
      ...
      <p className="text-white/50 text-sm mb-5">
        Install a Nostr extension to continue:
      </p>
      ...
      <button
        onClick={onClose}
        className="mt-6 text-white/30 text-xs cursor-pointer bg-transparent border-none"
      >
        Dismiss
      </button>
    </div>
      ...
      <div className="min-h-[calc(100vh-60px)] flex flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <div className="flex gap-3 mt-2">
          ...
          <button
            ...
            disabled={loading}
            className="px-6 py-2.5 border border-white/20 text-white text-sm rounded hover:border-white/40 transition-colors"
          >
